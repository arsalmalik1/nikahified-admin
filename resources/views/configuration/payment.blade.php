				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div id="lwTestStripeInputField">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('stripe_testing_secret_key') }}" id="lwStripeTestSecretKey" name="stripe_testing_secret_key" placeholder="<?= __tr('Secret Key') ?>">
						</div>
						<!-- / Testing Secret Key Key -->
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('stripe_testing_publishable_key') }}" id="lwStripeTestPublishKey" name="stripe_testing_publishable_key" placeholder="<?= __tr('Publish Key') ?>">
						</div>
						<!-- / Testing Publish Key -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-user" value="{{ getStoreSettings('stripe_testing_webhook_secret') }}"
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div id="lwLiveStripeInputField">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('stripe_live_secret_key') }}" id="lwStripeLiveSecretKey" name="stripe_live_secret_key" placeholder="<?= __tr('Secret Key') ?>">
						</div>
						<!-- / Live Secret Key Key -->
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('stripe_live_publishable_key') }}" id="lwStripeLivePublishKey" name="stripe_live_publishable_key" placeholder="<?= __tr('Publish Key') ?>">
						</div>
						<!-- / Live Publish Key -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-user" value="{{ getStoreSettings('stripe_live_webhook_secret') }}"
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div id="lwTestRazorpayInputField">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('razorpay_testing_key') }}" id="lwRazorpayTestKey" name="razorpay_testing_key" placeholder="<?= __tr('Razorpay Key') ?>">
						</div>
						<!-- / Testing Razorpay Key -->
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('razorpay_testing_secret_key') }}" id="lwRazorpayTestSecretKey" name="razorpay_testing_secret_key" placeholder="<?= __tr('Razorpay Secret Key') ?>">
						</div>
						<!-- / Testing Razorpay Secret Key -->
						 ...
						 <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-user" value="{{ getStoreSettings('razorpay_testing_webhook_secret') }}" id="lwRazorPayTestWebhookSecretKey" name="razorpay_testing_webhook_secret"
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div id="lwLiveRazorpayInputField">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('razorpay_live_key') }}" id="lwRazorpayLiveKey" name="razorpay_live_key" placeholder="<?= __tr('Razorpay Key') ?>">
						</div>
						<!-- / Live Razorpay Key Key -->
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="{{ getStoreSettings('razorpay_live_secret_key') }}" id="lwRazorpayLiveSecretKey" name="razorpay_live_secret_key" placeholder="<?= __tr('Razorpay Secret Key') ?>">
						</div>
						<!-- / Live Secret Key -->
						 <!-- Webhook secret -->
						 <div class="mb-3">
                            <label for="lwRazorPayLiveWebhookSecretKey"><?= __tr('Webhook Signing Secret') ?></label>
                            <input type="text" class="form-control form-control-user" value="{{ getStoreSettings('razorpay_live_webhook_secret') }}" id="lwRazorPayLiveWebhookSecretKey" name="razorpay_live_webhook_secret"
                                placeholder="<?= __tr('Webhook Signing Secret') ?>">
                    </div>
                    <!-- / Webhook secret -->
					</div>
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div id="lwTestCoingateInputField">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="<?= getStoreSettings('coingate_test_token') ?>" id="lwCoingateTestToken" name="coingate_test_token" placeholder="<?= __tr('Coingate Test Token') ?>">
						</div>
						<!-- / Testing Coingate Secret Key -->
					</div>
				</fieldset>
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div id="lwLiveCoingateInputField">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control form-control-user" value="<?= getStoreSettings('coingate_live_token') ?>" id="lwCoingateLiveToken" name="coingate_live_token" placeholder="<?= __tr('Coingate Live Token') ?>">
						</div>
						<!-- / Live Coingate Token -->
					</div>
					@else

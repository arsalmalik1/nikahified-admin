				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4 mb-3 mb-sm-0">
							...
							<input type="text" name="sms_textlocal_username" class="form-control form-control-user" required value="<?= $configurationData['sms_textlocal_username'] ?>" id="lwTextlocalUsername" placeholder="<?= __tr('Textlocal Username') ?>">
						</div>
						<!-- / Textlocal Username -->
						...
						<div class="col-sm-4 mb-3 mb-sm-0">
							...
							<input type="text" name="sms_textlocal_hash" class="form-control form-control-user" required value="<?= $configurationData['sms_textlocal_hash'] ?>" id="lwTextlocalHash" placeholder="<?= __tr('Textlocal Hash') ?>">
						</div>
						<!-- / Textlocal Hash -->
						<!-- Textlocal From -->
						<div class="col-sm-4 mb-3 mb-sm-0">
							<label for="lwTextlocalFrom"><?= __tr('Textlocal From') ?></label>
							<input type="text" name="sms_textlocal_from" class="form-control form-control-user" required value="<?= $configurationData['sms_textlocal_from'] ?>" id="lwTextlocalFrom" placeholder="<?= __tr('Textlocal From') ?>">
						</div>
						<!-- / Textlocal From -->
					</div>
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4 mb-3 mb-sm-0">
							...
							<input type="text" name="sms_twilio_sid" class="form-control form-control-user" required value="<?= $configurationData['sms_twilio_sid'] ?>" id="lwTwilioSID" placeholder="<?= __tr('Twilio SID') ?>">
						</div>
						<!-- / Twilio SID -->
						...
						<div class="col-sm-4 mb-3 mb-sm-0">
							...
							<input type="text" name="sms_twilio_token" class="form-control form-control-user" required value="<?= $configurationData['sms_twilio_token'] ?>" id="lwTwilioToken" placeholder="<?= __tr('Twilio Token') ?>">
						</div>
						<!-- / Twilio Token -->
						<!-- Twilio From -->
						<div class="col-sm-4 mb-3 mb-sm-0">
							<label for="lwTwilioFrom"><?= __tr('Twilio From') ?></label>
							<input type="text" name="sms_twilio_from" class="form-control form-control-user" required value="<?= $configurationData['sms_twilio_from'] ?>" id="lwTwilioFrom" placeholder="<?= __tr('Twilio From') ?>">
						</div>
						<!-- / Twilio From -->
					</div>
				</fieldset>
				...
				<fieldset class="lw-fieldset mb-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4 mb-3 mb-sm-0">
							...
							<input type="text" name="sms_sms77_apiKey" class="form-control form-control-user" required value="<?= $configurationData['sms_sms77_apiKey'] ?>" id="lwSms77ApiKey" placeholder="<?= __tr('Sms77 Api Key') ?>">
						</div>
						<!-- / Sms77 Api Key -->
						...
						<div class="col-sm-4 mb-3 mb-sm-0">
							...
							<input type="text" name="sms_sms77_flash" class="form-control form-control-user" required value="<?= $configurationData['sms_sms77_flash'] ?>" id="lwSms77Flush" placeholder="<?= __tr('Sms77 Flush') ?>">
						</div>
						<!-- / Sms77 Flush -->
						<!-- Sms77 From -->
						<div class="col-sm-4 mb-3 mb-sm-0">
							<label for="lwSms77From"><?= __tr('Sms77 From') ?></label>
							<input type="text" name="sms_sms77_from" class="form-control form-control-user" required value="<?= $configurationData['sms_sms77_from'] ?>" id="lwSms77From" placeholder="<?= __tr('Sms77 From') ?>">
						</div>
						<!-- / Sms77 From -->
					</div>
				</fieldset>

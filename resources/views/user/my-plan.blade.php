@section('page-title', __tr('My Plan'))
@section('head-title', __tr('My Plan'))
@section('keywordName', __tr('My Plan'))
@section('keyword', __tr('My Plan'))
@section('description', __tr('My Plan'))
@section('keywordDescription', __tr('My Plan'))
					...
					<div class="card-body">
						<div>
							...
							<div class="text-center">
								<a href="<?= route('user.payment_plans', ['username' => getUserAuthInfo('profile.username')]) ?>" class="btn btn-outline-primary btn-lg align-center" style="border-radius:10px">Change Plan</a>
							</div>
						</div>
					</div>
				</div>
